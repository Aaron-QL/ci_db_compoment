...
namespace OFashion\DAO\Contracts;

use OFashion\DAO\Exceptions\DB_Adapt_Exception;
use OFashion\DAO\PDO\PDO_Result;
...
abstract class DB_Driver
{
    ...
    {
        throw new DB_Adapt_Exception($msg);
    }
     ...
     *
     * @param    string $sql
     * @param bool $binds = FALSE        An array of binding data
     * @param    bool $return_object = NULL
     * @return    mixed
     * @throws DB_Adapt_Exception
     */
    public function query($sql, $binds = false, $return_object = null)
    {
        if ($sql === '') {
            throw new DB_Adapt_Exception('db_invalid_query');
        ...
        if (false === ($this->result_id = $this->simple_query($sql))) {
            ...
            if ($this->db_debug) {
                ...
                // Display errors
                $error = 'Error Number: ' . $error['code'] . '. message: ' . $error['message'] . '. sql: ' . $sql;
                throw new DB_Adapt_Exception($error);
            }
